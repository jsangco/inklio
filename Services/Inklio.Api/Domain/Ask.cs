...
public class Ask : Entity, IAggregateRoot
{
    ...
    protected Ask(string body, byte contentRating, User createdBy, bool isSpoiler, string title)
    {
        this.Body = body;
    ...
    /// <param name="title">The title of the <see cref="Ask"/> object.</param>
    public static Ask Create(string body, byte contentRating, User createdBy, bool isSpoiler, string title)
    {
        ...
        var ask = new Ask(body, contentRating, createdBy, isSpoiler, title);
        return ask;
    }
    ...
    public Delivery AddDelivery(string body, byte contentRating, User createdBy, bool isAi, bool isSpoiler, string title)
    {
