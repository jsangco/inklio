...
#pragma warning restore CS8618
    ...
    protected AskImage(Ask ask, User createdBy, Guid name, long sizeInBytes)
        : base(ask, createdBy, name, sizeInBytes)
    {
        this.AskId = ask.Id;
        this.Ask = ask;
    }
    ...
    /// <returns></returns>
    public static AskImage Create(Ask ask, User createdBy, long sizeInBytes)
    {
        // TODO: Validate
        ...
        var askBlob = new AskImage(ask, createdBy, Guid.NewGuid(), sizeInBytes);
        return askBlob;
    }
}