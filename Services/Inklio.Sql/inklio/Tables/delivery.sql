...
(
  ...
  [created_by_id] INT NOT NULL,
    CONSTRAINT [FK_delivery_created_by_id_user_id] FOREIGN KEY REFERENCES [inklio].[user] ([id]) ON UPDATE CASCADE,
  [edited_at_utc] DATETIME2 NULL,
  [edited_by_id] INT NULL,
    CONSTRAINT [FK_delivery_edited_by_id_user_id] FOREIGN KEY REFERENCES [inklio].[user] ([id]) ON UPDATE CASCADE,
